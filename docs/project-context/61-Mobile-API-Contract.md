...
| `client-auth` | `POST /client-auth/profile/contact-verification/send` | `ClientSavedContactVerificationSendInput` | `ClientVerificationCodeSendResult` |
| `client-auth` | `POST /client-auth/profile/contact-verification/confirm` | `ClientSavedContactVerificationConfirmInput` | `ClientSafeProfile` |
