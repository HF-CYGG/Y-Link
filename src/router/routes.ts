    ...
    children: [
      {
        path: 'scan',
        name: 'inventory-scan',
        component: routeViewLoaders['inventory-scan'],
        meta: {
          title: '扫码作业',
          menuOrder: 10,
          activeMenu: '/inventory',
          requiredPermissions: ['inventory:operate'],
          keepAlive: true,
        },
      },
      {
      ...
      {
        path: 'stocktakes/:id',
        name: 'inventory-stocktake-work',
        component: routeViewLoaders['inventory-stocktake-work'],
        meta: {
          title: '盘点作业',
          menu: false,
          activeMenu: '/inventory',
      ...
      },
      {
        path: 'docs',
        name: 'inventory-docs',
        component: routeViewLoaders['inventory-docs'],
        meta: {
          title: '库存单据',
          menuOrder: 40,
          activeMenu: '/inventory',
      ...
      },
      {
        path: 'logs',
        name: 'inventory-logs',
        component: routeViewLoaders['inventory-logs'],
        meta: {
          title: '库存流水',
          menuOrder: 50,
          activeMenu: '/inventory',
      ...
      {
        path: 'master-data',
        name: 'inventory-master-data',
        component: routeViewLoaders['inventory-master-data'],
        meta: {
          title: '分类与库位',
          menuOrder: 60,
          activeMenu: '/inventory',
